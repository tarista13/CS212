...
namespace Mankalah
{
    ...
    public class KalahMatch
    {
        ...
        private static Player pTop = new BonzoPlayer(Position.Top, timeLimit);	// TOP player (MAX) AlphaBetaPlayer
        private static Player pBot = new tja9Player(Position.Bottom, timeLimit);	// BOTTOM player	
